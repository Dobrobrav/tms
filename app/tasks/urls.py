...
urlpatterns = [
    ...
    path(
        'comments/',
        views.CommentView.as_view(create_comment_usecase=create_comment_usecase_factory()),
        name='comments',
    ),
    path('comments/<int:comment_id>', views.CommentView.as_view(get_comment_usecase=get_comment_usecase_factory())),
]
